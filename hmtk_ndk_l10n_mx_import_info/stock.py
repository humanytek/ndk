...
class stock_move(osv.osv):
    ...
    _columns = {
        ...
        'expense_amount': fields.float('Expenses'),
        }
stock_move()
class stock_picking(osv.osv):
    ...
    def _prepare_invoice_line(self, cr, uid, group, picking, move_line, invoice_id,
        ...
        price_unit = self._get_price_unit_invoice(cr, uid, move_line, invoice_vals['type']) +  (move_line.amount_igi/qty) + (move_line.expense_amount/qty)
        return {
            'name': name,
            'origin': origin,
