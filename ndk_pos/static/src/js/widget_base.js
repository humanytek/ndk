        ...
        build_currency_template: function(){
            ...
            this.format_currency = function(amount){
                ...
                if(this.currency.position === 'after'){
                    ...
                    return Intl.NumberFormat('en-US',{style:'currency',currency:'USD'}).format(amount) + ' USD';
                }else{
                    //return this.currency.symbol + ' ' + amount;
                    return 'USD ' + Intl.NumberFormat('en-US',{style:'currency',currency:'USD'}).format(amount);
                }
            }
